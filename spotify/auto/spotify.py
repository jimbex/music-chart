...
df.to_csv(f'{addr}\\music-chart\\spotify\\{m}{d}.csv')
...
df = pd.DataFrame(spot)
df = df.set_index('Position')
df.to_csv(f'{addr}\\music-chart\\spotify\\africa-{m}{d}.csv')
...
df = pd.DataFrame(spot)
df = df.set_index('Position')
df.to_csv(f'{addr}\\music-chart\\spotify\\afropop-{m}{d}.csv')
...
df = pd.DataFrame(spot)
df = df.set_index('Position')
df.to_csv(f'{addr}\\music-chart\\spotify\\afrohiphop-{m}{d}.csv')
...
df = pd.DataFrame(spot)
df = df.set_index('Position')
df.to_csv(f'{addr}\\music-chart\\spotify\\gospel-{m}{d}.csv')
...
df = pd.DataFrame(spot)
df = df.set_index('Position')
df.to_csv(f'{addr}\\music-chart\\spotify\\afrobeats-{m}{d}.csv')
...
df = pd.DataFrame(spot)
df = df.set_index('Position')
df.to_csv(f'{addr}\\music-chart\\spotify\\alternative-{m}{d}.csv')
