...
import pandas as pd
df1 = pd.read_csv(f'C:\\Users\\faree\\Desktop\\music charts\\spotify\\afropop-{m}{d - 6}.csv', encoding='utf-8')
df2 = pd.read_csv(f'C:\\Users\\faree\\Desktop\\music charts\\spotify\\afropop-{m}{d - 5}.csv', encoding='utf-8')
df3 = pd.read_csv(f'C:\\Users\\faree\\Desktop\\music charts\\spotify\\afropop-{m}{d - 4}.csv', encoding='utf-8')
df4 = pd.read_csv(f'C:\\Users\\faree\\Desktop\\music charts\\spotify\\afropop-{m}{d - 3}.csv', encoding='utf-8')
df5 = pd.read_csv(f'C:\\Users\\faree\\Desktop\\music charts\\spotify\\afropop-{m}{d - 2}.csv', encoding='utf-8')
df6 = pd.read_csv(f'C:\\Users\\faree\\Desktop\\music charts\\spotify\\afropop-{m}{d - 1}.csv', encoding='utf-8')
df7 = pd.read_csv(f'C:\\Users\\faree\\Desktop\\music charts\\spotify\\afropop-{m}{d}.csv', encoding='utf-8')
...
df.to_csv(f'C:\\Users\\faree\\Desktop\\music charts\\spotify\\spotify_afropop-week{w}.csv')
df.to_csv(f'C:\\Users\\faree\\Desktop\\music charts\\weekly charts\\afropop\\spotify_afropop-week{w}.csv')
