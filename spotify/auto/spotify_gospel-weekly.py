...
import pandas as pd
df1 = pd.read_csv(f'{addr}\\music-chart\\spotify\\gospel-{dates(6)}.csv')
df2 = pd.read_csv(f'{addr}\\music-chart\\spotify\\gospel-{dates(5)}.csv')
df3 = pd.read_csv(f'{addr}\\music-chart\\spotify\\gospel-{dates(4)}.csv')
df4 = pd.read_csv(f'{addr}\\music-chart\\spotify\\gospel-{dates(3)}.csv')
df5 = pd.read_csv(f'{addr}\\music-chart\\spotify\\gospel-{dates(2)}.csv')
df6 = pd.read_csv(f'{addr}\\music-chart\\spotify\\gospel-{dates(1)}.csv')
df7 = pd.read_csv(f'{addr}\\music-chart\\spotify\\gospel-{dates(0)}.csv')
...
df.to_csv(f'{addr}\\music-chart\\spotify\\spotify_gospel-week{w}.csv')
df.to_csv(f'{addr}\\music-chart\\weekly charts\\gospel\\spotify_gospel-week{w}.csv')
