...
import pandas as pd
df1 = pd.read_csv(f'{addr}\\music-chart\\spotify\\{dates(6)}.csv')
df2 = pd.read_csv(f'{addr}\\music-chart\\spotify\\{dates(5)}.csv')
df3 = pd.read_csv(f'{addr}\\music-chart\\spotify\\{dates(4)}.csv')
df4 = pd.read_csv(f'{addr}\\music-chart\\spotify\\{dates(2)}.csv')
df5 = pd.read_csv(f'{addr}\\music-chart\\spotify\\{dates(3)}.csv')
df6 = pd.read_csv(f'{addr}\\music-chart\\spotify\\{dates(1)}.csv')
df7 = pd.read_csv(f'{addr}\\music-chart\\spotify\\{dates(0)}.csv')
...
df.to_csv(f'{addr}\\music-chart\\spotify\\spotify-week{w}.csv')
df.to_csv(f'{addr}\\music-chart\\weekly charts\\songs\\spotify-week{w}.csv')
