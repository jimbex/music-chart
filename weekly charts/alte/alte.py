...
df2 = pd.read_csv(f'week{w-1}-alte50.csv')
...
df1.to_csv(f'week{w}-alte50.csv')
df1.to_csv(f'{addr}\\music-chart\\weekly charts\\weekly\\alte50.csv')
df1.to_json(f'{addr}\\webboard\\docs\\alte50.json')
df1.to_json(f'{addr}\\webboard\\week{w}\\alte50.json')
