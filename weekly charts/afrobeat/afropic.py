...
df = pd.read_csv(f'week{w}-afrobeats50.csv', encoding = 'utf-8')
song = list(df['song'])
...
df1.to_csv(f'week{w}-picafro100.csv', encoding='utf-8')
df1.to_json(f'{addr}\\webboard\\docs\\afrobeatpic.json')