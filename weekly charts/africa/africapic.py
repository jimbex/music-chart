...
df = pd.read_csv(f'africa_week{w}-song100.csv', encoding = 'utf-8')
song = list(df['song'])
...
df1.to_csv(f'week{w}-picafrica100.csv', encoding='utf-8')
df1.to_json(f'{addr}\\webboard\\docs\\africapic.json')